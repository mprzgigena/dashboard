...
declare global {
  ...
  const injectDynamicBackground: typeof import('../../utils/dynamic-bg')['injectDynamicBackground']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly injectDynamicBackground: UnwrapRef<typeof import('../../utils/dynamic-bg')['injectDynamicBackground']>
